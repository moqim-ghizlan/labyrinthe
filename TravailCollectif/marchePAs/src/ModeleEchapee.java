...
public class ModeleEchapee {
     ...
     */
    public ModeleEchapee(int hauteur, int largeur, List<List<Integer>> liste, int posx, int posy) {
        this.hauteur = hauteur;
        this.largeur = largeur;
        this.echapee=new Vector<Integer>(hauteur*largeur);
//        this.echapee=new Vector<Integer>((hauteur/32)*(largeur/32));
    ...
    public int getVal(int lig, int col){
        ...
        System.out.println(echapee.size());
    ...
    public Vector<Integer> getEchapee() {
        return echapee;
    }
    ...
    public static void main(String [] args){
        ...
        ModeleEchapee echapee=new ModeleEchapee(hauteur,largeur,liste, 5, 4);
