...
public class Utilisateur {
    ...
    public Utilisateur(int id, String pseudoUtilisateur, String mailUtilisateur, String mdpUtilisateur, char activUtilisateur, String roleUtilisateur, Blob avatarUtilisateur) {
        this.id=id;
