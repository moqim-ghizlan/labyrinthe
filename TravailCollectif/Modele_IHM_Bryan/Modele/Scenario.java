...
public class Scenario{
    ...
    private byte[] icone;
    private LocalTime tempsMaxScenario;
    private Date dateMiseEnLigne;
    private boolean BrouillonScenario;
    public Scenario(String titreScenario, String resumeScenario, byte[] icone, LocalTime tempsMaxScenario, Date dateMiseEnLigne, boolean BrouillonScenario, String messageTxt,byte[] imgTxt){
    ...
    public LocalTime getTempsMaxScenario(){
        return this.tempsMaxScenario;
        
    }
    
    public void setTempsMaxScenario(LocalTime tempsMaxScenario){
        this.tempsMaxScenario = tempsMaxScenario;
    }
