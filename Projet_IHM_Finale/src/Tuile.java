...
public class Tuile extends VBox {
     ...
     */
    Tuile(double largeur,double hauteur,double ratio, int lig, int col, Image image, boolean possedeEnigme) {
        super();
        //
...
//        avatarView.setFitWidth(50);
        ...
        this.ratio=ratio;
        this.possedeEnigme = possedeEnigme;
...
//        this.getChildren().add(avatarView);
    ...
    public boolean isPossedeEnigme() {
        return possedeEnigme;
    }
...
//            this.setBordure(Color.GRAY);
    ...
    public void setEtatEnigme(boolean etat){
        this.possedeEnigme = etat;
    }
}
